...
const ShowtimesPage = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            console.log("Starting data fetch with movieId:", movieId, "filters:", filters)
    ...
    const handleBookNow = (showtime) => {
        ...
        window.location.href = `/booking/${showtime._id}`
    }
                                        ...
                                        {Object.values(groupedShowtimes[date]).map((branchData) => (
                                            ...
                                            {formatTime(showtime.startTime)}
                                                                                ...
                                                                                <div className="text-sm text-gray-600">
                                                                                    ...
                                                                                    {showtime.theater?.type && ` (${showtime.theater.type})`}
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        {showtime.price && (
                                                                            <div className="mb-4">
                                                                                ...
                                                                                <div className="grid grid-cols-3 gap-2 text-xs">
                                                                                    ...
                                                                                    <div className="text-center">
                                                                                        <div className="text-gray-600">Couple</div>
                                                                                        <div className="font-semibold text-green-600">
                                                                        ...
                                                                        {/* Notes */}
                                                                        {showtime.notes && (
                                                                            <div className="text-xs text-gray-600 mb-3 italic">{showtime.notes}</div>
                                                                        )}
                        ...
                        <CardContent>
                            ...
                            <div className="space-y-2">
                                <p className="text-sm text-gray-400">
                                    Showing {showtimes.length} showtimes from {branches.length} branches
                                </p>
                                {showtimes.length > 0 && (
