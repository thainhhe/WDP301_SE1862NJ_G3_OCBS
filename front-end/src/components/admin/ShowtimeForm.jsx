...
const ShowtimeForm = ({ showtime, onSubmit, onCancel }) => {
    ...
    useEffect(() => {
        const loadInitialData = async () => {
            try {
                setLoadingStates((prev) => ({ ...prev, initial: true, movies: true, branches: true }))
                ...
                if (moviesResult.status === "fulfilled") {
                    ...
                    setDataErrors((prev) => ({ ...prev, movies: "Failed to load movies" }))
                    setMovies([])
                }
                ...
                if (branchesResult.status === "fulfilled") {
                    ...
                    setDataErrors((prev) => ({ ...prev, branches: "Failed to load branches" }))
                    setBranches([])
                }
            } catch (error) {
    ...
    useEffect(() => {
        const loadTheaters = async () => {
            ...
            try {
                ...
                if (theatersData && (theatersData.theaters || theatersData.data || Array.isArray(theatersData))) {
                    const theatersList = theatersData.theaters || theatersData.data || theatersData
                ...
                setDataErrors((prev) => ({ ...prev, theaters: "Failed to load theaters for this branch" }))
                setTheaters([])
            } finally {
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg p-8 max-w-sm w-full mx-4">
                    <div className="text-center">
                        ...
                        <h3 className="mt-4 text-lg font-semibold text-gray-900">Loading Form Data</h3>
                        <p className="mt-2 text-gray-600">Please wait while we fetch the required information...</p>
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[95vh] overflow-y-auto">
                ...
                <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-red-50 to-pink-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">{showtime ? "Edit Showtime" : "Create New Showtime"}</h2>
                            <p className="text-sm text-gray-600 mt-1">
                                {showtime ? "Update the showtime details below" : "Fill in the details to create a new showtime"}
                            </p>
                        </div>
                        <button
                            onClick={onCancel}
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                        <h3 className="text-sm font-medium text-gray-700 mb-3">Data Status</h3>
                    ...
                    <div className="space-y-8">
                                    ...
                                    <div className="mt-4 p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg border">
                                        <div className="flex items-start space-x-4">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="font-semibold text-gray-900 text-lg">{getSelectedMovie().title}</h4>
                              ...
                              <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                />
                                                ...
                                                {getSelectedMovie().description && (
                                                    <p className="mt-2 text-sm text-gray-600 line-clamp-2">{getSelectedMovie().description}</p>
                                                )}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select
                                        ...
                                        } ${loadingStates.branches || dataErrors.branches ? "bg-gray-100" : ""}`}
                                    >
                                        <option value="">
                                    ...
                                    {dataErrors.branches && <ErrorMessage message={dataErrors.branches} />}
                                </div>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        Standard Ticket Price ($) <span className="text-red-500">*</span>
                                    </label>
                                    <div className="relative">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-3">Special Features</label>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        {[
                                            { name: "is3D", label: "3D Showing", icon: "🎬" },
                                            { name: "isSpecialShowing", label: "Special Showing", icon: "⭐" },
